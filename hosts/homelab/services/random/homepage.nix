...
in
{
  virtualisation.oci-containers.containers.${myConstants.services.homepage.containerName} = {
    ...
    "${wandererIcon}:/app/public/icons/wanderer.svg"
